                                    ...
                                    <Table size='small' sx={{ width: '95%' }}>
                                        ...
                                        >
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell>{moment(complainData?.ComplainDate).format("DD-MM-YYYY")}</TableCell>
                                            </TableRow>
                                            {complainData?.FilePath && (<TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                        File Download:
                                                    </Typography>
                                                </TableCell>
                                                <TableCell> <a href={complainData?.FilePath} target="_blank" rel="noopener noreferrer">download file</a></TableCell>
                                            </TableRow>)}
                                            {/* <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
