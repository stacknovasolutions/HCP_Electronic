...
const AddFollowupDetails = props => {
    ...
    // ** Props
    const { open, toggle, defaultData } = props
    ...
    const onSubmit = async (data) => {
        const [error, result] = await asyncWrap(
            axios.post("/inquiry/follow-up", {
                ...data,
                inquiryId: defaultData?.InquriyID,
            })
        );
        if (!result) {
            console.log(error);
                    ...
                    <CardContent>
                        <Grid container spacing={6}>
                                    ...
                                    <Table size='small' sx={{ width: '95%' }}>
                                        ...
                                        >
                                            <TableRow>
                                                ...
                                                <TableCell>{defaultData?.InquiryID}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{defaultData?.ShortDescription}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell>{moment(defaultData?.QuatationDate).format("DD-MM-YYYY")}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{defaultData?.QuatationType}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{defaultData?.TotalAmount}</TableCell>
                                            </TableRow>
                                            {/* <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                            ...
                            <Timeline sx={{ m: 6 }}>
                                ...
                                {defaultData?.ReviewBy ? (<TimelineItem>
                                    <TimelineSeparator>
                                ...
                                {defaultData?.AcceptedBy ? (<TimelineItem>
                                    <TimelineSeparator>
                                        <TimelineDot color='primary' />
                                        <TimelineConnector />
                                    </TimelineSeparator>
                                ...
                                {defaultData?.ConfirmBy ? (<TimelineItem>
                                    <TimelineSeparator>
                                        <TimelineDot color='primary' />
                                        <TimelineConnector />
                                    </TimelineSeparator>
