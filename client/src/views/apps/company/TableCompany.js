...
const TableCompany = ({ show, setShow, showCompanyDetails, setShowCompanyDetails, setSelectedCompany, selectedCompany, showDeleteCompany, setShowDeleteCompany }) => {
  // ** State
      ...
      renderCell: ({ row }) => (
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          {ability?.can('Delete', 'Company') ? (
            <IconButton onClick={() => {
              setSelectedCompany(row);
              setShowDeleteCompany(!showDeleteCompany)
            }}>
