...
const DeleteTermCondition = props => {
  // ** Props
  ...
  const deleteDataById = async (id) => {
    try {
        ...
        const [error, result] = await asyncWrap(axios.delete(`/terms/${id}`));
      ...
      <Dialog fullWidth open={open} onClose={handleClose} sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 512 } }}>
        ...
        >
          ...
          >
            ...
            <Typography>You won't be able to revert terms!</Typography>
          </Box>
        </DialogContent>
        <DialogActions
          sx={{
        ...
        >
          <Button variant='contained' sx={{ mr: 2 }} onClick={() => deleteDataById(defaultData?.TermsConditionID)}>
            Yes, Delete Term & Condition!
          </Button>
