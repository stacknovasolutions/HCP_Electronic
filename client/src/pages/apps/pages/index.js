...
const Pages = () => {
  ...
  return (
    <Grid container spacing={6}>
      <PageHeader
        title={<Typography variant='h5'>Pages List</Typography>}
      />
      ...
      /> */}
      <Grid item xs={12}>
        <PagesTable deletePages={deletePages} setDeletePages={setDeletePages} show={open} setShow={setOpen} setDefaultData={setDefaultData} defaultData={defaultData} setShowPagesDetails={setShowPagesDetails} showPagesDetails={showPagesDetails} />
      </Grid>
      <DeletePages defaultData={defaultData} open={deletePages} setOpen={setDeletePages} />
      <ViewPages defaultData={defaultData} show={showPagesDetails} setShow={setShowPagesDetails} />
      <AddPages  defaultData={defaultData} show={open} setShow={setOpen} />
    </Grid>
  )
}
